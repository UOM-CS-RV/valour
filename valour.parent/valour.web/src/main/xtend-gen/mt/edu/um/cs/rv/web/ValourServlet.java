...
import mt.edu.um.cs.rv.web.ValourWebSetup;
...
public class ValourServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      ValourWebSetup _valourWebSetup = new ValourWebSetup(executorServiceProvider);
      _valourWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
